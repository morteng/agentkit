...
NOT_SECRETS: list[tuple[str, str]] = [
    ...
    ("screaming_snake", "ACME_APP_SIZE_CAP_BYTES"),
    ("kebab_slug", "acme-worker-completion-hook-v2"),
    ...
    ("dsn", "postgresql://localhost:5432/acme_dev"),
    ...
    ("ls_output", "-rw-r--r--  1 alice  staff  22849 Aug 15 14:55 firewall.py"),
