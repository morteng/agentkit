...
# consumers (e.g. REDACTED's evaluator) short-circuit with these reasons to
...
class AgentSession:
    ...
    def __init__(
        ...
        *,
        ...
        # lifetime only; external persistence (e.g. a REDACTED Task row) is the
    ...
    def set_goal(
        ...
        *,
        ...
        externally use it to correlate (e.g. a REDACTED Task row id).
